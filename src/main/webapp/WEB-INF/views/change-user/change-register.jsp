...
<head>
    <meta charset="UTF-8">
    <title>QA company | Sửa tài khoản</title>
    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
                <form:form class="login" id="a-form" method="POST" action="changeUser.htm" modelAttribute="user">
                   ...
                   <%--  <div class="login__field">
                    ...
                    <button type="submit" name="change" class="button login__submit">
                        <span class="button__text">Sửa thông tin </span>
